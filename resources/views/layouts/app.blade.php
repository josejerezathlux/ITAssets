    ...
    <div class="app-wrap">
        ...
        <aside class="app-sidebar" id="appSidebar">
            ...
            <nav class="app-sidebar-nav">
                ...
                <div class="nav-dropdown {{ request()->routeIs('assets.*', 'categories.*', 'digital-assets.*') ? 'open' : '' }}">
                    <a class="nav-link nav-link-dropdown-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#navInventory" aria-expanded="{{ request()->routeIs('assets.*', 'categories.*', 'digital-assets.*') ? 'true' : 'false' }}"><i class="bi bi-box-seam nav-icon"></i>Inventory</a>
                    <div class="collapse {{ request()->routeIs('assets.*', 'categories.*', 'digital-assets.*') ? 'show' : '' }}" id="navInventory">
