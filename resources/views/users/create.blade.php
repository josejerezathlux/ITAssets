...
<div class="corp-page-header">
    <div>
        <h2 class="corp-page-title mb-1"><i class="bi bi-person-plus me-2"></i>New User</h2>
        <p class="text-muted small mb-0">Create a user account. Role is required.</p>
    </div>
        ...
        <div class="corp-card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">Min 12 chars, mixed case, numbers, symbols.</small>
                ...
                <div class="col-12">
                    ...
                    <div class="d-flex gap-2 align-items-center flex-wrap">
                        <select name="role_id" id="userRoleSelect" class="form-select @error('role_id') is-invalid @enderror" required>
                            ...
                            @foreach($roles as $r)
                                <option value="{{ $r->id }}" {{ old('role_id') == $r->id ? 'selected' : '' }}>{{ $r->label }}</option>
                            @endforeach
                        </select>
